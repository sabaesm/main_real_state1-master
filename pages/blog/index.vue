<template>
  ...
  <div class="mainPage">
   ...
   <v-row >
   <v-col cols="12 " md="7"> <card v-bind="getBlog" :data="getBlog"></card></v-col>
     <v-col cols="12 " md="5"><search></search></v-col> 
   </v-row>
   </div>
    <slider></slider>
 </div>
...
.mainSection__cards .mainCard__weblog , .search_main_section{
   margin-top: -100px;
