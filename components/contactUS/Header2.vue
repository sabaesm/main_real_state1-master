<template>
  <div class="main_section">
   ...
   <div class="medium_container">
    <div class="navbar-info  mb-5 mt-5  " >
     <v-col cols="12">
      <h5 class="mt-4 ">برترین مشاورین املاک خاور میانه</h5>
      <h2 class="mr-4 pb-5 navbar-info__main_title "> ارتباط با ما</h2>
      <p class="pb-5 mb-5 aboutus_text  ">
        <span >
          <svg
            width="15"
            height="15"
