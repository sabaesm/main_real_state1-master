  ...
  <div class="larg_container">
    <div class="grouping-main-section">
      <div class="top_section d-flex flex-row align-center">
        <div>
          <h4>پیشنهادات داغ</h4>
          <h2 class="mb-5">پیشنهادات باورنکردنی ملک ها</h2>
        </div>

        <div class="arrows">
          <a href="#" class="see_more d-flex align-center justify-center pa-2 ma-0">
            <svg
              class="mx-3"
              width="26"
              height="26"
      ...
      <div >
        <div v-swiper="swiperOption" class="w-5/6 ml-auto relative" :loadtheme="false" >
          <ul
           class="swiper-wrapper my-5"
          >

            <li   class="sale__cards d-flex flex-row swiper-slide mx-0 my-0 pl-0 py-0 px-0"
            v-for="data in data"
            :key="data.id">
            <div class="ma-0 pa-0 sale__card__items d-flex flex-column flex-md-row">
              <v-col cols="12   pa-0 ma-0" md="5">
                <div class="top_card">
                  <a href="#">
              ...
              <v-col class="bottom_card pa-0 ma-0" cols="12" md="7">
                ...
                <ul class="home__desctiption">
                  ...
                  <li v-if="data.ground_width !== null">
                    عرض زمین:{{ data.ground_width }} متر
                  </li>
                  <li v-if="data.corrected_area !== null">
                    متراژ اطلاحی:{{ data.corrected_area }} متر
                  </li>
                  <li v-if="data.passage_width !== null">
                    عرض گذر:{{ data.passage_width }} متر
                  </li>
                  <li v-if="data.passage_width !== null">
                    عرض گذر:{{ data.passage_width }} متر
                  </li>
                ...
                <div class="sale_person__details d-flex flex-row w-100">
                  ...
                  <div class="sale_contact_way pa-0 ma-0">
                    ...
                    <a href="https://wa.me/09392832153" class="pa-0 ma-0"
                      ><svg
                        viewBox="0 0 44 44"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
