<template>
  <div class="medium_container">
    <v-row class="slider__top_section">
      <h5>ملک های مشابه</h5>
      <div class="arows d-flex flex-row">
        <div class="prev-button mx-1" slot="button-prev">
          <svg
            width="41"
            height="41"
            viewBox="0 0 61 61"
          ...
          >
            <rect width="61" height="61" rx="10" fill="#3370BC" />
            <path
              d="M32.7148 36L38.4291 31L32.7148 26"
              stroke="white"
              stroke-width="2.5"
        ...
        <div class="next-button d-none d-md-flex" slot="button-next">
          ...
          >
            <rect width="61" height="61" rx="10" fill="#3370BC" />
            <path
              d="M27.7148 36L22.0006 31L27.7148 26"
              stroke="white"
              stroke-width="2.5"
              stroke-miterlimit="10"
              stroke-linecap="round"
              ...
              <li class="cards">
                <div class="top_card">
                  ...
                  <div class="topcard__top__section">
                    <div class="status px-3">
                      <span class="sale__product">
                        <svg
                          width="22"
                          height="22"
                          viewBox="0 0 22 22"
                  ...
                  <span class="hover__icon_bottom">
                    <div class="cunter d-flex flex-column align-items-center p-2">
                      <span>6</span>
                      <span
                        ><svg
                          width="19"
                ...
                <div class="bottom_card">
                  ...
                  <v-row class="price__row m-0 px-0 py-2">
                    <span class="values">
                      <span>
                        <svg
                          width="11"
                  ...
                  <div class="sale_person__details d-flex flex-row w-100">
                    <div class="sale_person d-flex flex-row">
                      ...
                      <span class="d-flex flex-column p-1">
                        <h5 class="">{{ salecard.name }}</h5>
                        <p class="">{{ salecard.experience }}</p>
                      </span>
                    </div>
                    <row class="sale_contact_way">
                      <svg
                        class="ml-2"
                        viewBox="0 0 44 44"
                        fill="none"
...
.top_card img {
  width: 100%;
  object-fit: cover;
  transition: all ease-in-out 0.3 !important;
  border-radius: 10px;
  height: 230px;
}
.top_card:hover img {
