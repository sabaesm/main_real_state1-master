      ...
      <div v-swiper="swiperOption" class="w-5/6 ml-auto relative custom_swiper_container">
        <ul class="swiper-wrapper test">
          <li
            ...
            :key="data.id"
          >
            <div v-if="index <= 6" class="ma-0 pa-2 sale__card__items">
              <div class="top_card">
                <a href="#">
                ...
                <span class="hover__icon_bottom">
                  ...
                  <span class="sale_date"
                    >{{ data.placed_at | moment("from", "now") }}
                  </span>
                </span>
              </div>
              <v-col class="bottom_card pa-0 ma-0" cols="12">
                ...
                <div
                  class="sale_person__details d-flex flex-row w-100"
                  v-bind="usersinfo"
                  :key="usersinfo.id"
                >
...
export default {
  ...
  mounted() {
    ...
    usersinfo()
      .then((res) => (this.usersinfo = res.data))
